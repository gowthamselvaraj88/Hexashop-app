    ...
    <footer className="bg-black dark:bg-gray-900">
      <div className="container mx-auto px-20">
        ...
        <div className="py-6 flex flex-col items-center md:flex-col md:items-center ">
          ...
          <div className="contents"><p className="text-white" >Design:<span className="text-[#a9d8b3]">Inoesis</span></p>
          <p className="text-white">Distributed By:<span className="text-[#a9d8b3]">Inoesis</span></p></div>
          <div className="flex mt-4 sm:mt-0 space-x-5 p-5">
            <Link
              href="#"
              className="text-[#a9d8b3] hover:text-white-900 dark:hover:text-white"
            >
              <svg
                className="w-4 h-4"
                viewBox="0 0 8 19"
            ...
            <Link
              href="#"
              className="text-[#a9d8b3] hover:text-white-900 dark:hover:text-white ms-5 ml-3"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
