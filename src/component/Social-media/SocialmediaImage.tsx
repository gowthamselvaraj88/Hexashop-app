...
const SocialmediaImage = (props: any) => {
  return (
      <div className="relative bg-gray-900 group" >
        <img
          className="absolute inset-0 object-fill w-full h-full group-hover:opacity-50"
          src={props.iamgeLink}/>
        <div className="relative w-auto h-[155px]">
          <div className="mt-8 ml-24">
            <div className="transition-all transform 
								translate-y-8 opacity-0 
								group-hover:opacity-100 
								group-hover:translate-y-0">
                <h4 className="text-lg text-white">{props.category}</h4>
