  ...
  return (
    <div>
        <div className='container mx-auto'>
             <div className='md:ml-[150px] lg:ml-[330px] '>
            <h3 className='text-2xl md:text-4xl font-bold ml-[50px] p-3'>Our Amazing Team</h3>
            <p className='text-[#d4d4d4] italic text-xs md:text-sm p-2'>Details to details is what makes Hexashop different from the other themes.</p>
          </div>
